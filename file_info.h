...
public:
    ...
    file_info(struct stat *file_stat, const string &relative_path) {
        ...
        this->file_meta.atime = file_stat->st_atime;
        this->file_meta.mtime = file_stat->st_mtime;
        this->file_meta.ctime = file_stat->st_ctime;
    ...
    static file_info read_from_binary(char *buffer, size_t size) {
        ...
        file.absolute_path = string(buffer + sizeof(meta),
